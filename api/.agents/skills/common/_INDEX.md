...
| **common-business-requirements** | `BRD.md`, `docs/specs/product-brief-*.md`, `specs/*.md` | create brd, business requirements, business case, stakeholder impact, as-is to to-be, roi justification |
...
| **common-product-requirements** | `PRD.md`, `docs/specs/prd-*.md`, `specs/*.md` | create prd, product requirements, draft requirements, new feature spec, acceptance criteria |
...
| **common-software-requirements** | `SRS.md`, `docs/specs/srs-*.md`, `specs/*.md` | create srs, software requirements, functional specification, system behavior spec, technical requirements, non-functional requirements |
